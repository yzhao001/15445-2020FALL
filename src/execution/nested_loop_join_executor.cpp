...
void NestedLoopJoinExecutor::Init() {
  std::vector<Tuple> left_tuple, right_tuple;
...
Tuple NestedLoopJoinExecutor::merge_left_right(Tuple &left, const Schema *left_schema, Tuple &right,
...
void NestedLoopJoinExecutor::getValues(Tuple &tuple, const Schema *schema, std::vector<Value> &values) {
